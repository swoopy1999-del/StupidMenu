...
Il2Cpp.$config.exports = {
    il2cpp_init: () => Il2Cpp.module.findExportByName("piZpYcnBBvT"),
    il2cpp_init_utf16: () => Il2Cpp.module.findExportByName("HeXTaGlmHzi"),
    il2cpp_shutdown: () => Il2Cpp.module.findExportByName("KIhxxXagKCh"),
    il2cpp_set_config_dir: () => Il2Cpp.module.findExportByName("azksPRhWSnp"),
    il2cpp_set_data_dir: () => Il2Cpp.module.findExportByName("ppqbeLWlHVr"),
    il2cpp_set_temp_dir: () => Il2Cpp.module.findExportByName("uanxqrmQLod"),
    il2cpp_set_commandline_arguments: () => Il2Cpp.module.findExportByName("Df_wSzSdgNV"),
    il2cpp_set_commandline_arguments_utf16: () => Il2Cpp.module.findExportByName("ezknzEnsupR"),
    il2cpp_set_config_utf16: () => Il2Cpp.module.findExportByName("rrmDLYlXfeO"),
    il2cpp_set_config: () => Il2Cpp.module.findExportByName("xwJVXGkJsOF"),
    il2cpp_set_memory_callbacks: () => Il2Cpp.module.findExportByName("xkkTjCmRJJS"),
    il2cpp_memory_pool_set_region_size: () => Il2Cpp.module.findExportByName("hroq_klRVAw"),
    il2cpp_memory_pool_get_region_size: () => Il2Cpp.module.findExportByName("dghPLpQYdwu"),
    il2cpp_get_corlib: () => Il2Cpp.module.findExportByName("TxwRxmQsBBz"),
    il2cpp_add_internal_call: () => Il2Cpp.module.findExportByName("cjXYtNUPDaT"),
    il2cpp_resolve_icall: () => Il2Cpp.module.findExportByName("PURhRyIFMZi"),
    il2cpp_alloc: () => Il2Cpp.module.findExportByName("cSFqwMGRAxF"),
    il2cpp_free: () => Il2Cpp.module.findExportByName("qgQkBEwxcrp"),
    il2cpp_array_class_get: () => Il2Cpp.module.findExportByName("jodMoRVfV__"),
    il2cpp_array_length: () => Il2Cpp.module.findExportByName("uphyRWJDOoj"),
    il2cpp_array_get_byte_length: () => Il2Cpp.module.findExportByName("OFPvrBJDnAa"),
    il2cpp_array_new: () => Il2Cpp.module.findExportByName("_yfv_LHjVAs"),
    il2cpp_array_new_specific: () => Il2Cpp.module.findExportByName("MeyPOOFnUiM"),
    il2cpp_array_new_full: () => Il2Cpp.module.findExportByName("oajqDoQEpxw"),
    il2cpp_bounded_array_class_get: () => Il2Cpp.module.findExportByName("YGBTjJDpUTM"),
    il2cpp_array_element_size: () => Il2Cpp.module.findExportByName("ayEnh_uHUpD"),
    il2cpp_assembly_get_image: () => Il2Cpp.module.findExportByName("ZKjLJpPWlHD"),
    il2cpp_class_enum_basetype: () => Il2Cpp.module.findExportByName("T_GkrzrCaGl"),
    il2cpp_class_from_system_type: () => Il2Cpp.module.findExportByName("AZFnHGJbUqH"),
    il2cpp_class_is_inited: () => Il2Cpp.module.findExportByName("RrnkNOdReRy"),
    il2cpp_class_is_generic: () => Il2Cpp.module.findExportByName("SgoHaKSoWeN"),
    il2cpp_class_is_inflated: () => Il2Cpp.module.findExportByName("WkyIFvNbADA"),
    il2cpp_class_is_assignable_from: () => Il2Cpp.module.findExportByName("brmZcJZkGdg"),
    il2cpp_class_is_subclass_of: () => Il2Cpp.module.findExportByName("kiazWrlBpRv"),
    il2cpp_class_has_parent: () => Il2Cpp.module.findExportByName("vRyuytWlepq"),
    il2cpp_class_from_il2cpp_type: () => Il2Cpp.module.findExportByName("ABCpLEBIRnP"),
    il2cpp_class_from_name: () => Il2Cpp.module.findExportByName("AUdhXtQhgQe"),
    il2cpp_class_get_element_class: () => Il2Cpp.module.findExportByName("AYklAHLYqAe"),
    il2cpp_class_get_events: () => Il2Cpp.module.findExportByName("Aa_KDQwFYpj"),
    il2cpp_class_get_fields: () => Il2Cpp.module.findExportByName("AjZJRnu__Af"),
    il2cpp_class_get_nested_types: () => Il2Cpp.module.findExportByName("Altwb_ZcBJb"),
    il2cpp_class_get_interfaces: () => Il2Cpp.module.findExportByName("AzwnMuXZoNt"),
    il2cpp_class_get_properties: () => Il2Cpp.module.findExportByName("BFrRhBkyHWn"),
    il2cpp_class_get_property_from_name: () => Il2Cpp.module.findExportByName("NmtJgLliHcf"),
    il2cpp_class_get_field_from_name: () => Il2Cpp.module.findExportByName("QfvAkMYSCIQ"),
    il2cpp_class_get_methods: () => Il2Cpp.module.findExportByName("bsnnwUpqGFk"),
    il2cpp_class_get_method_from_name: () => Il2Cpp.module.findExportByName("BJzXlGdqExa"),
    il2cpp_class_get_name: () => Il2Cpp.module.findExportByName("BliGGXVmSAv"),
    il2cpp_class_get_namespace: () => Il2Cpp.module.findExportByName("BzkbhomeAzU"),
    il2cpp_class_get_parent: () => Il2Cpp.module.findExportByName("CCTnoTkiQBw"),
    il2cpp_class_get_declaring_type: () => Il2Cpp.module.findExportByName("CHKnlssWmMr"),
    il2cpp_class_instance_size: () => Il2Cpp.module.findExportByName("CHzwQGHBKyc"),
    il2cpp_class_num_fields: () => Il2Cpp.module.findExportByName("DzWWCrOOTvF"),
    il2cpp_class_is_valuetype: () => Il2Cpp.module.findExportByName("ECpoFGCbxCA"),
    il2cpp_class_is_blittable: () => Il2Cpp.module.findExportByName("EGEFUvLWnLR"),
    il2cpp_class_value_size: () => Il2Cpp.module.findExportByName("ETXTmRUyGEW"),
    il2cpp_class_get_flags: () => Il2Cpp.module.findExportByName("EiifjlWBvsw"),
    il2cpp_class_is_abstract: () => Il2Cpp.module.findExportByName("EognJdpNNOq"),
    il2cpp_class_is_interface: () => Il2Cpp.module.findExportByName("EqipknZX_QC"),
    il2cpp_class_array_element_size: () => Il2Cpp.module.findExportByName("FAMJXVRQdBp"),
    il2cpp_class_from_type: () => Il2Cpp.module.findExportByName("FCpfLRDvhdm"),
    il2cpp_class_get_type: () => Il2Cpp.module.findExportByName("FYsTvMtGGYe"),
    il2cpp_class_get_type_token: () => Il2Cpp.module.findExportByName("FiFzhLnprCr"),
    il2cpp_class_has_attribute: () => Il2Cpp.module.findExportByName("FzLZpvXyxcv"),
    il2cpp_class_has_references: () => Il2Cpp.module.findExportByName("GdukesZcLTP"),
    il2cpp_class_is_enum: () => Il2Cpp.module.findExportByName("HApLGSuPQNW"),
    il2cpp_class_get_image: () => Il2Cpp.module.findExportByName("HblbQLyBvAf"),
    il2cpp_class_get_assemblyname: () => Il2Cpp.module.findExportByName("HnWCvPwsOGc"),
    il2cpp_class_get_rank: () => Il2Cpp.module.findExportByName("HtkofNrVNTu"),
    il2cpp_class_get_data_size: () => Il2Cpp.module.findExportByName("IGfpFOpUeft"),
    il2cpp_class_get_static_field_data: () => Il2Cpp.module.findExportByName("ILMpfGoDTms"),
    il2cpp_stats_dump_to_file: () => Il2Cpp.module.findExportByName("IOYmpQHXNYr"),
    il2cpp_stats_get_value: () => Il2Cpp.module.findExportByName("IXdwZlocjQF"),
    il2cpp_domain_get: () => Il2Cpp.module.findExportByName("IaABPXoJOBv"),
    il2cpp_domain_assembly_open: () => Il2Cpp.module.findExportByName("IiWOpEFVLbE"),
    il2cpp_domain_get_assemblies: () => Il2Cpp.module.findExportByName("ItHRIuIwtZU"),
    il2cpp_raise_exception: () => Il2Cpp.module.findExportByName("JPLuYiMvGqp"),
    il2cpp_exception_from_name_msg: () => Il2Cpp.module.findExportByName("JhYGhEMNjIQ"),
    il2cpp_get_exception_argument_null: () => Il2Cpp.module.findExportByName("JqusTgsHpcm"),
    il2cpp_format_exception: () => Il2Cpp.module.findExportByName("JxNjTaqSNjx"),
    il2cpp_format_stack_trace: () => Il2Cpp.module.findExportByName("KCobzBXbqXo"),
    il2cpp_unhandled_exception: () => Il2Cpp.module.findExportByName("KeQFjFouDZH"),
    il2cpp_native_stack_trace: () => Il2Cpp.module.findExportByName("KfyGzNHxUpg"),
    il2cpp_field_get_name: () => Il2Cpp.module.findExportByName("KqdvYkQtfbV"),
    il2cpp_field_get_flags: () => Il2Cpp.module.findExportByName("L_lLtTgGeyo"),
    il2cpp_field_get_from_reflection: () => Il2Cpp.module.findExportByName("LpXHQkLGcHU"),
    il2cpp_field_get_parent: () => Il2Cpp.module.findExportByName("Lz_RGWbpcuk"),
    il2cpp_field_get_object: () => Il2Cpp.module.findExportByName("PFiCrG_aNMo"),
    il2cpp_field_get_offset: () => Il2Cpp.module.findExportByName("UmZhGLheUrA"),
    il2cpp_field_get_type: () => Il2Cpp.module.findExportByName("qEKIaOdSYWL"),
    il2cpp_field_get_value: () => Il2Cpp.module.findExportByName("sdgTAydHVqK"),
    il2cpp_field_get_value_object: () => Il2Cpp.module.findExportByName("NBLWrnCyszX"),
    il2cpp_field_has_attribute: () => Il2Cpp.module.findExportByName("N_ClTdZLGQi"),
    il2cpp_field_set_value: () => Il2Cpp.module.findExportByName("NdMJhszIWOa"),
    il2cpp_field_set_value_object: () => Il2Cpp.module.findExportByName("NhYwLkxwifN"),
    il2cpp_field_static_get_value: () => Il2Cpp.module.findExportByName("OJWceG_yRzN"),
    il2cpp_field_static_set_value: () => Il2Cpp.module.findExportByName("OjMnYq__Tcn"),
    il2cpp_field_is_literal: () => Il2Cpp.module.findExportByName("PGhcWqwemLq"),
    il2cpp_gc_collect: () => Il2Cpp.module.findExportByName("PMVuYboZHlD"),
    il2cpp_gc_collect_a_little: () => Il2Cpp.module.findExportByName("PP_HAyVteqP"),
    il2cpp_gc_start_incremental_collection: () => Il2Cpp.module.findExportByName("PSJHeeVPsa_"),
    il2cpp_gc_enable: () => Il2Cpp.module.findExportByName("PnDZziz_WKM"),
    il2cpp_gc_disable: () => Il2Cpp.module.findExportByName("QttPGIOveKP"),
    il2cpp_gc_is_disabled: () => Il2Cpp.module.findExportByName("RmZzCgdfcfS"),
    il2cpp_gc_set_mode: () => Il2Cpp.module.findExportByName("RyDVhirOSUN"),
    il2cpp_gc_is_incremental: () => Il2Cpp.module.findExportByName("RyRxQepF_ii"),
    il2cpp_gc_get_max_time_slice_ns: () => Il2Cpp.module.findExportByName("SMnoMrUALPE"),
    il2cpp_gc_set_max_time_slice_ns: () => Il2Cpp.module.findExportByName("SOXVjpMADdY"),
    il2cpp_gc_get_used_size: () => Il2Cpp.module.findExportByName("lFETcPUtjNl"),
    il2cpp_gc_get_heap_size: () => Il2Cpp.module.findExportByName("SRWmSkRcNnV"),
    il2cpp_gc_foreach_heap: () => Il2Cpp.module.findExportByName("StsEmUmquCg"),
    il2cpp_stop_gc_world: () => Il2Cpp.module.findExportByName("SxujmvOXmON"),
    il2cpp_start_gc_world: () => Il2Cpp.module.findExportByName("TBprmQp_ZLT"),
    il2cpp_gc_alloc_fixed: () => Il2Cpp.module.findExportByName("TkcXQUFsQjA"),
    il2cpp_gc_free_fixed: () => Il2Cpp.module.findExportByName("TsRpdOHCXBp"),
    il2cpp_gchandle_new: () => Il2Cpp.module.findExportByName("UBJimwBgwal"),
    il2cpp_gchandle_new_weakref: () => Il2Cpp.module.findExportByName("rPWaAAVITGk"),
    il2cpp_gchandle_get_target: () => Il2Cpp.module.findExportByName("UJlyCSkQZCA"),
    il2cpp_gchandle_foreach_get_target: () => Il2Cpp.module.findExportByName("USUnDFqCGgU"),
    il2cpp_gc_wbarrier_set_field: () => Il2Cpp.module.findExportByName("USylZBuaTZh"),
    il2cpp_gc_has_strict_wbarriers: () => Il2Cpp.module.findExportByName("UVBPWDozl_Y"),
    il2cpp_gc_set_external_allocation_tracker: () => Il2Cpp.module.findExportByName("UuGhgiqsfNr"),
    il2cpp_gc_set_external_wbarrier_tracker: () => Il2Cpp.module.findExportByName("UyciWZNuxmd"),
    il2cpp_gchandle_free: () => Il2Cpp.module.findExportByName("VGqJpiBLzdc"),
    il2cpp_object_header_size: () => Il2Cpp.module.findExportByName("VUhagvgglhb"),
    il2cpp_array_object_header_size: () => Il2Cpp.module.findExportByName("VbMNvljqYRC"),
    il2cpp_offset_of_array_length_in_array_object_header: () => Il2Cpp.module.findExportByName("VrghBiQpMfr"),
    il2cpp_offset_of_array_bounds_in_array_object_header: () => Il2Cpp.module.findExportByName("WVCWlKiWEfa"),
    il2cpp_allocation_granularity: () => Il2Cpp.module.findExportByName("WgMjdbXUVgV"),
    il2cpp_unity_liveness_allocate_struct: () => Il2Cpp.module.findExportByName("WpoyLXxTSPj"),
    il2cpp_unity_liveness_calculation_from_root: () => Il2Cpp.module.findExportByName("WuqhsrVyfXX"),
    il2cpp_unity_liveness_calculation_from_statics: () => Il2Cpp.module.findExportByName("XWzYVoBTHlk"),
    il2cpp_unity_liveness_finalize: () => Il2Cpp.module.findExportByName("XqArBhqmGJK"),
    il2cpp_unity_liveness_free_struct: () => Il2Cpp.module.findExportByName("YFDuLokphko"),
    il2cpp_method_get_return_type: () => Il2Cpp.module.findExportByName("YS_zohdPsxm"),
    il2cpp_method_get_from_reflection: () => Il2Cpp.module.findExportByName("YgSYuDI_ifP"),
    il2cpp_method_get_object: () => Il2Cpp.module.findExportByName("YpukNFDhDqW"),
    il2cpp_method_get_name: () => Il2Cpp.module.findExportByName("ZESCPCqauiP"),
    il2cpp_method_is_generic: () => Il2Cpp.module.findExportByName("ZHRtWPKUZyp"),
    il2cpp_method_is_inflated: () => Il2Cpp.module.findExportByName("ZWhEIpEuQsW"),
    il2cpp_method_is_instance: () => Il2Cpp.module.findExportByName("ZWqaEUgHpKz"),
    il2cpp_method_get_param_count: () => Il2Cpp.module.findExportByName("ZbwprUHuzNn"),
    il2cpp_method_get_param: () => Il2Cpp.module.findExportByName("_EiPFWPqdSr"),
    il2cpp_method_get_class: () => Il2Cpp.module.findExportByName("_JTv_wrfJmB"),
    il2cpp_method_has_attribute: () => Il2Cpp.module.findExportByName("_WrhHTheyvr"),
    il2cpp_method_get_declaring_type: () => Il2Cpp.module.findExportByName("_lYbDGRjlxZ"),
    il2cpp_method_get_flags: () => Il2Cpp.module.findExportByName("_mELxKlWEJQ"),
    il2cpp_method_get_token: () => Il2Cpp.module.findExportByName("aD_ClMMptZE"),
    il2cpp_method_get_param_name: () => Il2Cpp.module.findExportByName("aMmzWWoGgFo"),
    il2cpp_profiler_install: () => Il2Cpp.module.findExportByName("asJndqSTObY"),
    il2cpp_profiler_set_events: () => Il2Cpp.module.findExportByName("btCJHQpGXJL"),
    il2cpp_profiler_install_enter_leave: () => Il2Cpp.module.findExportByName("cJp_CGSULoR"),
    il2cpp_profiler_install_allocation: () => Il2Cpp.module.findExportByName("cOHLtmlqJvC"),
    il2cpp_profiler_install_gc: () => Il2Cpp.module.findExportByName("cPKpEqJDzOf"),
    il2cpp_profiler_install_fileio: () => Il2Cpp.module.findExportByName("cTfILPoiadC"),
    il2cpp_profiler_install_thread: () => Il2Cpp.module.findExportByName("cciRgyjCvst"),
    il2cpp_property_get_name: () => Il2Cpp.module.findExportByName("cicrUbWZARg"),
    il2cpp_property_get_get_method: () => Il2Cpp.module.findExportByName("coCdmTGFnCr"),
    il2cpp_property_get_set_method: () => Il2Cpp.module.findExportByName("ctIrkZMOEhm"),
    il2cpp_property_get_parent: () => Il2Cpp.module.findExportByName("czefkPs_XBr"),
    il2cpp_property_get_flags: () => Il2Cpp.module.findExportByName("dAPKuWdJSEy"),
    il2cpp_object_get_class: () => Il2Cpp.module.findExportByName("dGjTTrJKUol"),
    il2cpp_object_get_size: () => Il2Cpp.module.findExportByName("dWhGbeXhi_u"),
    il2cpp_object_get_virtual_method: () => Il2Cpp.module.findExportByName("dWpngJVysvS"),
    il2cpp_object_new: () => Il2Cpp.module.findExportByName("deYdFqHrXvD"),
    il2cpp_object_unbox: () => Il2Cpp.module.findExportByName("dxCnU_PnRff"),
    il2cpp_value_box: () => Il2Cpp.module.findExportByName("eADHvti_KwE"),
    il2cpp_monitor_enter: () => Il2Cpp.module.findExportByName("eCD_qepxxar"),
    il2cpp_monitor_try_enter: () => Il2Cpp.module.findExportByName("eYvqWkMVHiV"),
    il2cpp_monitor_exit: () => Il2Cpp.module.findExportByName("eoFRdONFDDH"),
    il2cpp_monitor_pulse: () => Il2Cpp.module.findExportByName("ewFMejLOeXB"),
    il2cpp_monitor_pulse_all: () => Il2Cpp.module.findExportByName("fD_yzZmNLpR"),
    il2cpp_monitor_wait: () => Il2Cpp.module.findExportByName("fUUgIogTHH_"),
    il2cpp_monitor_try_wait: () => Il2Cpp.module.findExportByName("fXka_oclgl_"),
    il2cpp_runtime_invoke_convert_args: () => Il2Cpp.module.findExportByName("fgp_bxEplNV"),
    il2cpp_runtime_invoke: () => Il2Cpp.module.findExportByName("g_IhGeDAllc"),
    il2cpp_runtime_class_init: () => Il2Cpp.module.findExportByName("gaAvCs_ZkST"),
    il2cpp_runtime_object_init: () => Il2Cpp.module.findExportByName("gfUKVRCZkkf"),
    il2cpp_runtime_object_init_exception: () => Il2Cpp.module.findExportByName("gi_PSZIqjIn"),
    il2cpp_runtime_unhandled_exception_policy_set: () => Il2Cpp.module.findExportByName("hPsPYqwNmWK"),
    il2cpp_string_length: () => Il2Cpp.module.findExportByName("hzgRq_JFCbH"),
    il2cpp_string_chars: () => Il2Cpp.module.findExportByName("iDfMtxsIHfX"),
    il2cpp_string_new: () => Il2Cpp.module.findExportByName("iDmgcWFLBzE"),
    il2cpp_string_new_wrapper: () => Il2Cpp.module.findExportByName("iPszfnbykIA"),
    il2cpp_string_new_utf16: () => Il2Cpp.module.findExportByName("iaOSLCqErjy"),
    il2cpp_string_new_len: () => Il2Cpp.module.findExportByName("iddOttmcuRz"),
    il2cpp_string_intern: () => Il2Cpp.module.findExportByName("iwdvvIkxJZm"),
    il2cpp_string_is_interned: () => Il2Cpp.module.findExportByName("jSkeVHqsSvZ"),
    il2cpp_thread_current: () => Il2Cpp.module.findExportByName("jXEMFxHETpi"),
    il2cpp_thread_attach: () => Il2Cpp.module.findExportByName("jattMeMdGjZ"),
    il2cpp_thread_detach: () => Il2Cpp.module.findExportByName("jpiCDJWGtnc"),
    il2cpp_is_vm_thread: () => Il2Cpp.module.findExportByName("jqArYcotgQX"),
    il2cpp_current_thread_walk_frame_stack: () => Il2Cpp.module.findExportByName("jsVLGeJPqjr"),
    il2cpp_thread_walk_frame_stack: () => Il2Cpp.module.findExportByName("kBgJmUscyCr"),
    il2cpp_current_thread_get_top_frame: () => Il2Cpp.module.findExportByName("kliOLJixQPp"),
    il2cpp_thread_get_top_frame: () => Il2Cpp.module.findExportByName("lFOoISeFwLR"),
    il2cpp_current_thread_get_frame_at: () => Il2Cpp.module.findExportByName("la_zqcylscB"),
    il2cpp_thread_get_frame_at: () => Il2Cpp.module.findExportByName("ltxVJKbIAee"),
    il2cpp_current_thread_get_stack_depth: () => Il2Cpp.module.findExportByName("mbDjiNSgjcJ"),
    il2cpp_thread_get_stack_depth: () => Il2Cpp.module.findExportByName("mjrlhVaygyF"),
    il2cpp_set_default_thread_affinity: () => Il2Cpp.module.findExportByName("mvskiJRiz_w"),
    il2cpp_override_stack_backtrace: () => Il2Cpp.module.findExportByName("mxFQYJttCPM"),
    il2cpp_type_get_object: () => Il2Cpp.module.findExportByName("nZnHpGoCohN"),
    il2cpp_type_get_type: () => Il2Cpp.module.findExportByName("nmjaRRzOLcm"),
    il2cpp_type_get_class_or_element_class: () => Il2Cpp.module.findExportByName("nnJsSH_Ihfo"),
    il2cpp_type_get_name: () => Il2Cpp.module.findExportByName("oOEXTkPqTDc"),
    il2cpp_type_get_assembly_qualified_name: () => Il2Cpp.module.findExportByName("oWnGVgPJXZr"),
    il2cpp_type_get_reflection_name: () => Il2Cpp.module.findExportByName("pDCxzwEoUHF"),
    il2cpp_type_is_byref: () => Il2Cpp.module.findExportByName("pTlcmYiBxME"),
    il2cpp_type_get_attrs: () => Il2Cpp.module.findExportByName("pxEmdmuekMj"),
    il2cpp_type_equals: () => Il2Cpp.module.findExportByName("qCrvAibCxkV"),
    il2cpp_type_is_static: () => Il2Cpp.module.findExportByName("qmLp_LsHcFq"),
    il2cpp_type_is_pointer_type: () => Il2Cpp.module.findExportByName("rEjbXOjrWRW"),
    il2cpp_image_get_assembly: () => Il2Cpp.module.findExportByName("rNfuRqToCnn"),
    il2cpp_image_get_name: () => Il2Cpp.module.findExportByName("rgppn_YbYPu"),
    il2cpp_image_get_filename: () => Il2Cpp.module.findExportByName("rrmRdmfEEfl"),
    il2cpp_image_get_entry_point: () => Il2Cpp.module.findExportByName("sBANgskDPin"),
    il2cpp_image_get_class_count: () => Il2Cpp.module.findExportByName("sljryqXHrle"),
    il2cpp_image_get_class: () => Il2Cpp.module.findExportByName("thOEciPSNzp"),
    il2cpp_capture_memory_snapshot: () => Il2Cpp.module.findExportByName("tjwJWEydoFn"),
    il2cpp_free_captured_memory_snapshot: () => Il2Cpp.module.findExportByName("tpeWnlKVjND"),
    il2cpp_set_find_plugin_callback: () => Il2Cpp.module.findExportByName("uEzBDlGxUQG"),
    il2cpp_register_log_callback: () => Il2Cpp.module.findExportByName("uJkgPAMgLeb"),
    il2cpp_debugger_set_agent_options: () => Il2Cpp.module.findExportByName("u_pAxqETThh"),
    il2cpp_is_debugger_attached: () => Il2Cpp.module.findExportByName("ugXsYEUuTFl"),
    il2cpp_register_debugger_agent_transport: () => Il2Cpp.module.findExportByName("uqaoYAkMGUr"),
    il2cpp_debug_foreach_method: () => Il2Cpp.module.findExportByName("vetTdnuXHyf"),
    il2cpp_debug_get_method_info: () => Il2Cpp.module.findExportByName("wLhrEUvcCXl"),
    il2cpp_unity_install_unitytls_interface: () => Il2Cpp.module.findExportByName("wRszBJcRqUR"),
    il2cpp_custom_attrs_from_class: () => Il2Cpp.module.findExportByName("wTcdfavYqoY"),
    il2cpp_custom_attrs_from_method: () => Il2Cpp.module.findExportByName("xOoledFPtji"),
    il2cpp_custom_attrs_from_field: () => Il2Cpp.module.findExportByName("yNfVTYxbhCR"),
    il2cpp_custom_attrs_has_attr: () => Il2Cpp.module.findExportByName("ybLZyDpJXXq"),
    il2cpp_custom_attrs_get_attr: () => Il2Cpp.module.findExportByName("ykIiGOVxX_Z"),
    il2cpp_custom_attrs_construct: () => Il2Cpp.module.findExportByName("zAvPTUt_mVE"),
    il2cpp_custom_attrs_free: () => Il2Cpp.module.findExportByName("zEkN_vkuXdm"),
    il2cpp_type_get_name_chunked: () => Il2Cpp.module.findExportByName("zFIhXQFBbBi"),
    il2cpp_class_set_userdata: () => Il2Cpp.module.findExportByName("zFiVjgg_CCO"),
    il2cpp_class_get_userdata_offset: () => Il2Cpp.module.findExportByName("zWfMdSclFAA"),
    il2cpp_class_for_each: () => Il2Cpp.module.findExportByName("zaPZ_llWvmP"),
    il2cpp_unity_set_android_network_up_state_func: () => Il2Cpp.module.findExportByName("ziAfaTAjP_Z"),
};
...
let whitelistedGunPlayer = null;
let rightPrimary = false;
let rightSecondary = false;
let leftGrab = false;
let rightGrab = false;
let selectedPlayer = null;
let playerListMode = true;
...
let bgColor = [0.04, 0.08, 0.20, 1.0];
let textColor = [1.0, 1.0, 1.0, 1.0];
let buttonColor = [0.10, 0.35, 0.85, 1.0];
let buttonPressedColor = [0.25, 0.65, 1.0, 1.0];
let menuName = "larp.wtf";
...
const itemIDs = [
    "item_ac_cola", "item_alphablade", "item_anti_gravity_grenade", "item_apple", "item_arena_pistol",
...
const mobIDs = [
    ...
    { name: "MomBossController", id: 44 },
    { name: "MomBossController", id: 45 },
    { name: "MomBossController", id: 46 },
    { name: "MomBossController", id: 47 },
    { name: "MomBossController", id: 48 },
    { name: "MomBossController", id: 49 },
    { name: "MomBossController", id: 50 },
];
...
Il2Cpp.perform(() => {
    ...
    const objectReference = Il2Cpp.reference(Il2Cpp.domain.assembly("mscorlib").image.class("System.Object").alloc());
    ...
    const prefabList = [
        ...
        'RPGRocket', 'RPGRocketEgg', 'RPGRocketSpear', 'RobotDogRPG', 'item_randombox_base',
        'StickyAnchor', 'SpawnableZipline', 'NetLootSpawnGroup', 'Vehicle_Buggy',
        'TeleportationManager', 'FlareGunProjectile', 'GrenadeProjectile',
        ...
        'AutoDestroyItem_Splash5', 'SlenderMonster', 'SpaceshipTeleporter', 'MazeManager',
        'ThunderController', 'Shipwheel', 'TeleportMachine', 'CoreTeleporter',
        'MetaCameraControls', 'LaserMirror', 'LaserSource', 'LaserSink', 'mom_pillow',
        'RiggedPlank', 'SharkScareTriggerObject', 'Uvula', 'MovieTheater', 'GreenscreenNET',
        'BonfireController', 'FortuneTellerNet', 'Explosion_AntiGravity', 'Explosion_Bomb',
        'Explosion_Bomber', 'Explosion_BroccoliGrenade', 'Explosion_ClusterGrenade',
        'Explosion_Dynamite', 'Explosion_Egg', 'Explosion_Flashbang', 'Explosion_FlyingSwarm',
        'Explosion_Grenade', 'Explosion_Heart_Gun', 'Explosion_ImpulseGrenade',
        'Explosion_Landmine', 'Explosion_RPG', 'Explosion_RPG_Spear', 'Explosion_SellingMachine',
        'Explosion_StashGrenade', 'Explosion_TeleGrenade', 'Explosion_Tripwire',
        'Explosion_Vehicle', 'ExplosiveEgg', 'ExplosiveEggClustered', 'Landmine',
        'ItemSellingMachineController', 'ClawMachineNetObject', 'SkiRaceController',
        'RamEventNet', 'NetGameTimeManager', 'HordeMobController', 'HordeMobLobbyHandler',
        'LeaderBoardMonsterKill', 'GiantRockObject', 'GiantRockObject_Fire', 'LongAisleController',
        ...
        'BigHatchdoorNetObject', 'HatchdoorGrabHandle', 'HatchdoorNetObject', 'KeypadDoorNetObject',
        'SimpleKeypadDoor', 'LockedShippingContainer_Quest', 'Mausoleum_01',
        'BarrelBeansDynamic', 'BarrelBeansStatic', 'BarrelExplodingDynamic', 'BarrelExplodingStatic',
        'BarrelOilDynamic', 'BarrelOilStatic', 'FourLeafQuest_FourLeafSpawner',
        'EasterEgg_QuestSpawner', 'RadarPartSpawner', 'BaitShopButton_Spawner',
        'GenericWorldItemSpawner', 'FuelCanisterSpawner', 'FuelCanisterNetObject',
        'LakePineapple_Spawner', 'LootLantern', 'LockedDoor_KeySpawner', 'LogQuestItemSpawner',
        'MountainKey_Spawner', 'Snail_Spawner', 'Spawner_Key', 'VHSQuests_VHSSpawner',
        'WinterFilm_ReelSpawner', 'BigWheelhandleSpawner', 'MimicSpawner_CemeteryTile1',
        'MimicSpawner_CemeteryTile3', 'Basketball', 'BigBanana', 'Net', 'NetMobSpawnGroup',
        'TubeMonster', 'DummyPlayerTarget', 'DummyTarget', 'DiggableGrave',
        'ChoppableTreeManager', 'EscherToyBlockObject', 'MomToyBlockObject',
        'MomToyBlockObject_DisappearOnDrop', 'BrainPowerPlug', 'remote_controller_receiver',
        'grababble_fish_paper_message', 'NetworkedLever_SecretLeft', 'HellAltar',
    ...
    function renderMenuText(canvasObject, text = "", color = [1, 1, 1, 1], pos = zeroVector, size = oneVector) {
        ...
        title.method("set_fontSize").invoke(0.7);
        ...
        title.method("set_resizeTextMinSize").invoke(0.4);
        title.method("set_resizeTextMaxSize").invoke(1.3);
    ...
    function renderMenu() {
        ...
        const menuBackground = createObject([0.1, 0, 0], identityQuaternion, [0.1, 1.1, 1], 3, bgColor, getTransform(menu));
        ...
        const letters = "larp.wtf";
        let animatedTitle = "";
        for (let li = 0; li < letters.length; li++) {
            const lh = ((menuHue / 360.0) + (li / letters.length)) % 1.0;
            const lr = Math.floor((Math.sin(lh * Math.PI * 2 + 0) * 0.5 + 0.5) * 255);
            const lg = Math.floor((Math.sin(lh * Math.PI * 2 + 2.094) * 0.5 + 0.5) * 255);
            const lb = Math.floor((Math.sin(lh * Math.PI * 2 + 4.188) * 0.5 + 0.5) * 255);
            const lhex = "#" + lr.toString(16).padStart(2, "0") + lg.toString(16).padStart(2, "0") + lb.toString(16).padStart(2, "0");
            animatedTitle += `<color=${lhex}>${letters[li]}</color>`;
        }
        renderMenuText(canvasObject, `${animatedTitle} <color=grey>v${version}</color><color=grey>[</color><color=white>${currentPage + 1}</color><color=grey>]</color>\n<color=grey>FPS: </color><color=white>${fpsDisplay}</color>`, textColor, [0.11, 0, 0.175], [1, 0.1]);
        if (time > notifactionResetTime)
            currentNotification = "";
        renderMenuText(canvasObject, currentNotification, textColor, [0.11, 0, 0.275], [1, 0.1]);
        const disconnectButton = createObject([0.1, 0.0, 0.225], identityQuaternion, [0.09, 0.99, 0.08], 3, buttonColor, getTransform(menu));
        ...
        targetMods.forEach((buttonData, index) => {
            const button = createObject([0.105, 0, 0.13 - (i * 0.04)], identityQuaternion, [0.09, 0.99, 0.08], 3, buttonColor, getTransform(menu));
    ...
    let GunPointer = null;
    let GunLine = null;
    let lagSX = 0, lagSY = 0, lagSZ = 0;
    let lagEX = 0, lagEY = 0, lagEZ = 0;
    let lagInit = false;
    function renderGun() {
        ...
        if (finalRay) {
            ...
            EndPosition = Vector3.method("op_Addition").invoke(StartPosition, Vector3.method("op_Multiply").invoke(Direction, 50));
        }
        if (GunPointer == null || GunPointer.isNull?.()) {
            GunPointer = createObject(EndPosition, identityQuaternion, [0.08, 0.08, 0.08], 0, [0, 0, 1, 1]);
            try {
                Destroy(getComponent(GunPointer, Collider));
            }
            catch (_) { }
        }
        ...
        pMat.method("set_color").invoke(rightTrigger ? [0, 0, 1, 1] : [0, 0.5, 1, 1]);
        ...
        GunLine.method("set_startColor").invoke([0, 0, 0, 1]);
        GunLine.method("set_endColor").invoke([0, 0, 0, 1]);
        ...
        const segments = 10;
        GunLine.method("set_positionCount").invoke(segments + 1);
        GunLine.method("SetPosition").invoke(0, StartPosition);
        const upVector = Math.abs(Direction[1]) > 0.9 ? [0, 0, 1] : [0, 1, 0];
        const perpX = Vector3.method("Cross").invoke(Direction, upVector);
        const perpY = Vector3.method("Cross").invoke(Direction, perpX);
        const shakeIntensity = 0.15;
        for (let i = 1; i < segments; i++) {
            const t = i / segments;
            const lerpedPos = Vector3.method("Lerp").invoke(StartPosition, EndPosition, t);
            const offsetFactorX = (Math.random() * 2 - 1) * shakeIntensity;
            const offsetFactorY = (Math.random() * 2 - 1) * shakeIntensity;
            const offsetX = Vector3.method("op_Multiply").invoke(perpX, offsetFactorX);
            const offsetY = Vector3.method("op_Multiply").invoke(perpY, offsetFactorY);
            const totalOffset = Vector3.method("op_Addition").invoke(offsetX, offsetY);
            const jaggedPos = Vector3.method("op_Addition").invoke(lerpedPos, totalOffset);
            GunLine.method("SetPosition").invoke(i, jaggedPos);
        }
        GunLine.method("SetPosition").invoke(segments, EndPosition);
    ...
    let beforeSpawnDelegate = null;
    let beforeSpawnDelegateClass = null;
    let validatorBypassEnabled = false;
    function enableMobValidatorBypass() {
        if (validatorBypassEnabled)
            return;
        Il2Cpp.domain
            ...
            .implementation = () => true;
        validatorBypassEnabled = true;
    }
    function getBeforeMobSpawnDelegate() {
        if (beforeSpawnDelegate)
            return beforeSpawnDelegate;
        beforeSpawnDelegateClass = Il2Cpp.domain
        ...
        const validator = Il2Cpp.domain
            .assembly("AnimalCompany")
            .image.class("AnimalCompany.MobSpawnValidator");
        beforeSpawnDelegate = Il2Cpp.delegate(beforeSpawnDelegateClass, (_runner, networkObject) => {
            if (!networkObject || networkObject.handle?.isNull())
                return;
    ...
    function spawnMob(mobName, position, rotation = identityQuaternion) {
        ...
        const cleanName = String(mobName).replace(/^mob_prefab\//, "");
        const candidates = [
            cleanName,
            cleanName.replace(/Controller$/, ""),
            cleanName.replace(/_?Controller$/, "")
        ];
        let mobId = null;
        ...
        if (mobId === null)
            return false;
        prefabGenerator.method("SpawnMobAsync", 6).overload("AnimalCompany.MobID", "UnityEngine.Vector3", "UnityEngine.Quaternion", "Fusion.NetworkRunner.OnBeforeSpawned", "Fusion.NetworkObjectSpawnDelegate", "System.String").invoke(mobId, position, rotation, getBeforeMobSpawnDelegate(), objectReference, Il2Cpp.string("mod"));
        return true;
    }
    ...
    const buttons = [
        [
            ...
            new ButtonInfo({
                ...
                isTogglable: false,
                toolTip: "Opens the Mobs category."
            }),
        ],
        [
            new ButtonInfo({
        ...
        [
            ...
            new ButtonInfo({
                ...
                method: () => {
                    ...
                    switch (themeIndex) {
                        case 0:
                            bgColor = [0.04, 0.08, 0.20, 1.0];
                            textColor = [1.0, 1.0, 1.0, 1.0];
                            buttonColor = [0.10, 0.35, 0.85, 1.0];
                            buttonPressedColor = [0.25, 0.65, 1.0, 1.0];
        ...
        [
                ...
                method: () => {
                    try {
                        ...
                        for (let i = 0; i < players.length; i++) {
                            ...
                            if (!p || p.isNull())
                                continue;
                            p.method("RPC_AddPlayerMoney").invoke(9999999);
                        }
                    }
                    catch (e) {
                        console.error("rich all error:", e);
                    }
                },
                toolTip: "Gives all players money."
            }),
            new ButtonInfo({
            ...
            new ButtonInfo({
                ...
                method: () => {
                    try {
                        if (leftGrab && leftTrigger) {
                            spawnNetworkPrefab("RPGRocketEgg", leftHandTransform.method("get_position").invoke(), leftHandTransform.method("get_rotation").invoke());
                        }
                        if (rightGrab && rightTrigger) {
                            spawnNetworkPrefab("RPGRocketEgg", rightHandTransform.method("get_position").invoke(), rightHandTransform.method("get_rotation").invoke());
                        }
                    }
                    catch (e) {
                        console.error(e);
            ...
            new ButtonInfo({
                buttonText: "Robot Dog RPG Launcher?",
                isTogglable: true,
                method: () => {
                    try {
                        if (leftGrab && leftTrigger) {
                            spawnNetworkPrefab("RobotDogRPG", leftHandTransform.method("get_position").invoke(), leftHandTransform.method("get_rotation").invoke());
                        }
                        if (rightGrab && rightTrigger) {
                            spawnNetworkPrefab("RobotDogRPG", rightHandTransform.method("get_position").invoke(), rightHandTransform.method("get_rotation").invoke());
                        }
                    }
                    catch (e) {
                        console.error(e);
                        ...
                        try {
                            ...
                            for (let i = 0; i < players.length; i++) {
                                try {
                                    ...
                                    for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                        try {
                                            const interactor = p.method("GetHandInteractor", 1).invoke(handIndex);
                                            if (!interactor)
                                                continue;
                                            const itemAnchor = interactor.field("_itemAnchor").value;
                                            if (!itemAnchor)
                                            ...
                                            if (!grabbable || grabbable.isNull())
                                                continue;
                                            spawnNetworkPrefab("RPGRocket", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                        }
                                        catch (_) { }
                                    }
                                }
                            ...
                            console.error("whitelist all rpg error:", e);
                        }
                    };
                })(),
                toolTip: "Whitelists RPG rockets for every player in the room. Hold grip + trigger."
            }),
            new ButtonInfo({
                ...
                enableMethod: () => {
                    try {
                        ...
                        sendNotification("pls work");
                    }
                    catch (e) {
                        console.error("block all rpcs error:", e);
                    }
                },
                disableMethod: () => {
                    try {
                        ...
                        sendNotification("Block All RPCs OFF", false);
                    }
                    catch (e) {
                        console.error("block all rpcs disable error:", e);
                    }
                },
                isTogglable: true,
                toolTip: "Blocks all incoming RPCs on your NetPlayer. Nothing can affect you."
            }),
            new ButtonInfo({
                buttonText: "Nut spam",
                isTogglable: true,
        ...
        [
            ...
            new ButtonInfo({
                ...
                isTogglable: false,
                toolTip: "Cycles to the previous prefab."
            }),
            new ButtonInfo({
            ...
            // this menu was by harmony and lottabtle
            new ButtonInfo({
                ...
                disableMethod: function () {
                    ...
                    const d = buttons.flat().find(b => b.buttonText === "Prefab Orbit")?.method?._disable;
                    if (d)
                        d();
                },
                toolTip: "Orbit lol."
        ...
        [
            ...
            new ButtonInfo({
                buttonText: "Mob Spawn In Hand",
                method: () => {
                    const handTransform = rightHandTransform;
                    if (rightSecondary && rightGrab) {
                        spawnMob(mobIDs[mobIndex].name, handTransform.method("get_position").invoke(), handTransform.method("get_rotation").invoke());
                    }
                },
                isTogglable: true,
                toolTip: "Hold right grip + B to spawn selected mob in your right hand."
            }),
            new ButtonInfo({
                buttonText: "Mob Gun",
                isTogglable: true,
                method: () => {
                    ...
                    if (rightTrigger) {
                        try {
                            const hitPoint = ray.method("get_point").invoke();
                            spawnMob(mobIDs[mobIndex].name, hitPoint, identityQuaternion);
                            sendNotification("Spawned mob: " + mobIDs[mobIndex].name, false);
                        }
                        catch (e) {
                            console.error("mob gun error:", e);
                        }
                    }
                },
                toolTip: "Point and shoot to spawn the selected mob where you aim. Hold right grip + trigger."
            }),
            new ButtonInfo({
                ...
                method: (() => {
                    let mobOrbitObjects = [];
                    let mobOrbitAngle = 0;
                    let mobOrbitInit = false;
                    const MOB_ORBIT_COUNT = 3;
                    const MOB_ORBIT_RADIUS = 5.0;
                    const MOB_ORBIT_SPEED = 80.0;
                    const disableMobOrbit = () => {
                        mobOrbitObjects = [];
                        mobOrbitInit = false;
                    };
                    const update = () => {
                        try {
                            if (!mobOrbitInit) {
                                mobOrbitObjects = [];
                                for (let i = 0; i < MOB_ORBIT_COUNT; i++) {
                                    const pos = getTransform(headCollider).method("get_position").invoke();
                                    spawnMob(mobIDs[mobIndex].name, pos, identityQuaternion);
                                }
                                mobOrbitInit = true;
                            }
                            mobOrbitAngle += MOB_ORBIT_SPEED * deltaTime;
                            if (mobOrbitAngle > 360)
                                mobOrbitAngle -= 360;
                            const centerPos = getTransform(headCollider).method("get_position").invoke();
                            const mobs = Object.method("FindObjectsOfType").inflate(AssemblyCSharp.class("AnimalCompany.MobController")).invoke();
                            if (!mobs)
                                return;
                            const count = Math.min(mobs.length, MOB_ORBIT_COUNT);
                            for (let i = 0; i < count; i++) {
                                const mob = mobs.get(mobs.length - 1 - i);
                                if (!mob || mob.isNull())
                                    continue;
                                const angleOffset = (360 / MOB_ORBIT_COUNT) * i;
                                const rad = (mobOrbitAngle + angleOffset) * (Math.PI / 180);
                                const offsetX = Math.cos(rad) * MOB_ORBIT_RADIUS;
                                const offsetZ = Math.sin(rad) * MOB_ORBIT_RADIUS;
                                const offsetVec = Vector3.method("op_Addition").invoke(Vector3.method("op_Multiply").invoke(Vector3.field("rightVector").value, offsetX), Vector3.method("op_Multiply").invoke(Vector3.field("forwardVector").value, offsetZ));
                                const targetPos = Vector3.method("op_Addition").invoke(centerPos, offsetVec);
                                getTransform(mob).method("set_position").invoke(targetPos);
                            }
                        }
                        catch (e) {
                            console.error("mob orbit error:", e);
                        }
                    };
                    update._disable = disableMobOrbit;
                    return update;
                })(),
                disableMethod: function () {
                    const d = buttons.flat().find(b => b.buttonText === "Mob Orbit")?.method?._disable;
                    if (d)
                        d();
                },
                toolTip: "Spawns mobs that orbit around you."
            }),
        ],
    ];
    ...
    function rebuildPlayerButtons() {
        buttons[12].splice(0);
        if (playerListMode) {
            buttons[12].push(new ButtonInfo({
                buttonText: "Exit Players",
                method: () => { currentCategory = 0; currentPage = 0; playerListMode = true; },
                isTogglable: false,
                toolTip: "Returns to main menu."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Refresh List",
                method: () => { playerListMode = true; rebuildPlayerButtons(); reloadMenu(); },
                isTogglable: false,
            ...
            try {
                ...
                if (players) {
                    for (let i = 0; i < players.length; i++) {
                        ...
                        let label = "Player " + i;
                        try {
                            const nameVal = p.method("get_displayName").invoke();
                            if (nameVal && !nameVal.isNull()) {
                                label = nameVal.toString().replace(/^"|"$/g, "");
                            }
                        }
                        catch (_) {
                            try {
                                const nameField = p.field("_displayName").value;
                                if (nameField && !nameField.isNull()) {
                                    label = nameField.toString().replace(/^"|"$/g, "");
                                }
                            }
                            catch (_) { }
                        }
                        ...
                        buttons[12].push(new ButtonInfo({
                            buttonText: capturedLabel,
                            method: () => {
                                selectedPlayer = captured;
                                playerListMode = false;
                                rebuildPlayerButtons();
                                reloadMenu();
                            },
                            isTogglable: false,
                            toolTip: "Select " + capturedLabel
                        }));
                    }
                }
            }
            ...
            buttons[12].push(new ButtonInfo({
                ...
                method: () => { playerListMode = true; rebuildPlayerButtons(); reloadMenu(); },
                isTogglable: false,
                toolTip: "Back to player list."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Big Player",
                isTogglable: false,
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        selectedPlayer.method("set_playerScale").invoke(3.0);
                        selectedPlayer.method("set_playerHeadSize").invoke(50);
                    }
                    catch (e) {
                        console.error("big player error:", e);
                    }
                },
                toolTip: "Makes selected player very big."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Shrink Player",
                isTogglable: false,
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        selectedPlayer.method("set_playerScale").invoke(0.1);
                        selectedPlayer.method("set_playerHeadSize").invoke(-50);
                    }
                    catch (e) {
                        console.error("shrink player error:", e);
                    }
                },
                toolTip: "Makes selected player very small."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Stinky",
                method: () => { try {
                    selectedPlayer?.method("RPC_TagAsStinky").invoke();
                }
                catch (e) { } },
                isTogglable: false,
                toolTip: "Stinky selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "TP To Me",
                method: () => { try {
                    selectedPlayer?.method("RPC_Teleport").invoke(getTransform(GTPlayer).method("get_position").invoke());
                }
                catch (e) { } },
                isTogglable: false,
                toolTip: "Pull selected player to you."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "TP To Them",
                method: () => { try {
                    teleportPlayer(getTransform(selectedPlayer).method("get_position").invoke());
                    rigidbody.method("set_linearVelocity").invoke(zeroVector);
                }
                catch (e) { } },
                isTogglable: false,
            ...
            buttons[12].push(new ButtonInfo({
                buttonText: "Fling",
                method: () => { try {
                    selectedPlayer?.method("RPC_AddForce").invoke([1000, 1000, 1000]);
                }
                catch (e) { } },
                isTogglable: false,
                toolTip: "Fling selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "God Player",
                isTogglable: true,
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        selectedPlayer.method("set_isInvincible").invoke(true);
                    }
                    catch (e) {
                        console.error("god player error:", e);
                    }
                },
                disableMethod: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        selectedPlayer.method("set_isInvincible").invoke(false);
                    }
                    catch (e) { }
                },
                toolTip: "No dying yay."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Kick",
                method: () => { try {
                ...
                isTogglable: false,
                toolTip: "Kick selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Rich",
                method: () => { try {
                    selectedPlayer?.method("RPC_AddPlayerMoney").invoke(9999999);
                }
                catch (e) { } },
                isTogglable: false,
            ...
            buttons[12].push(new ButtonInfo({
                buttonText: "Rainbow",
                method: () => { try {
                    selectedPlayer?.method("RPC_SetColorHSV").invoke(5, hue, 1.0, 1.0);
                }
                catch (e) { } },
                isTogglable: true,
                toolTip: "Rainbow selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Blind",
                method: () => { try {
                    selectedPlayer?.method("RPC_SetColorHSV").invoke(NaN, NaN, NaN, NaN);
                }
                catch (e) { } },
                isTogglable: true,
                toolTip: "Blind selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Jelly",
                method: () => { try {
                    selectedPlayer?.method("RPC_SetJellyEffect").invoke(jellywowes, jellywowes);
                }
                catch (e) { } },
                isTogglable: true,
                toolTip: "Jelly selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Break Game",
                method: () => {
                    try {
                        selectedPlayer?.method("RPC_Teleport").invoke([0, -9999999, 0]);
                        selectedPlayer?.method("RPC_AddForce").invoke([1500, 1500, 1500]);
                    }
                    catch (e) { }
                },
                isTogglable: false,
                toolTip: "Break game for selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Orbit Me",
                isTogglable: true,
                method: (() => {
                    ...
                    return () => {
                        try {
                            if (!selectedPlayer || selectedPlayer.isNull())
                                return;
                            orbitAngle += 90.0 * deltaTime;
                            if (orbitAngle > 360)
                                orbitAngle -= 360;
                            const centerPos = getTransform(headCollider).method("get_position").invoke();
                            const rad = orbitAngle * (Math.PI / 180);
                            const offsetX = Math.cos(rad) * 1.5;
                            const offsetZ = Math.sin(rad) * 1.5;
                            const offsetVec = Vector3.method("op_Addition").invoke(Vector3.method("op_Multiply").invoke(Vector3.field("rightVector").value, offsetX), Vector3.method("op_Multiply").invoke(Vector3.field("forwardVector").value, offsetZ));
                            const targetPos = Vector3.method("op_Addition").invoke(centerPos, offsetVec);
                            selectedPlayer.method("RPC_Teleport").invoke(targetPos);
                        }
                        catch (e) { }
                    };
                })(),
                toolTip: "Orbit selected player around you."
            }));
            buttons[12].push(new ButtonInfo({
                ...
                method: (() => {
                    return () => {
                        try {
                            if (!selectedPlayer || selectedPlayer.isNull())
                                return;
                            const playerView = selectedPlayer.method("get_playerView").invoke();
                            if (!playerView || playerView.isNull())
                                return;
                            const rightSecondaryPressed = selectedPlayer.field("_rightSecondaryButton").value;
                            if (!rightSecondaryPressed)
                                return;
                            const pos = getTransform(selectedPlayer).method("get_position").invoke();
                            const forward = getTransform(selectedPlayer).method("get_forward").invoke();
                            const newPos = Vector3.method("op_Addition").invoke(pos, Vector3.method("op_Multiply").invoke(forward, 25.0 * deltaTime));
                            selectedPlayer.method("RPC_Teleport").invoke(newPos);
                        }
                        catch (e) {
                            console.error("whitelist fly error:", e);
                        }
                    };
                })(),
                toolTip: "Weeeeeeeeee."
                    ...
                    return () => {
                        try {
                            if (!selectedPlayer || selectedPlayer.isNull())
                                return;
                            if (frozenPos == null) {
                                frozenPos = getTransform(selectedPlayer).method("get_position").invoke();
                            }
                            selectedPlayer.method("RPC_Teleport").invoke(frozenPos);
                        }
                        catch (e) { }
                    };
                })(),
                toolTip: "Freeze selected player in place."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Hold In Hand",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            if (!selectedPlayer || selectedPlayer.isNull())
                                return;
                            let targetHandTransform = rightHandTransform;
                            if (leftGrab && !rightGrab) {
                                targetHandTransform = leftHandTransform;
                            }
                            const handPos = targetHandTransform.method("get_position").invoke();
                            const handForward = targetHandTransform.method("get_forward").invoke();
                            const handUp = targetHandTransform.method("get_up").invoke();
                            const forwardOffset = Vector3.method("op_Multiply").invoke(handForward, 0.2);
                            const upOffset = Vector3.method("op_Multiply").invoke(handUp, 0.1);
                            const targetPos = Vector3.method("op_Addition").invoke(Vector3.method("op_Addition").invoke(handPos, forwardOffset), upOffset);
                            selectedPlayer.method("RPC_Teleport").invoke(targetPos);
                        }
                        catch (e) {
                            console.error("hold in hand error:", e);
                        }
                    };
                })(),
                toolTip: "Just Grabs Him."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "WhiteList Ammo Spam",
                isTogglable: true,
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                        ...
                        console.error("ammo spam error:", e);
                    }
                },
                toolTip: "Spams ammo pickups at the selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "WhiteList Nut Spam",
                isTogglable: true,
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        const pos = getTransform(selectedPlayer).method("get_position").invoke();
                        PickupManager.method("SpawnPickup", 4).invoke(2, pos, 5, true);
                    }
                    catch (e) {
                        console.error("nut spam error:", e);
                    }
                },
                toolTip: "Spams nut pickups at the selected player."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist RPG",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    const interactor = selectedPlayer.method("GetHandInteractor", 1).invoke(handIndex);
                                    if (!interactor)
                                        continue;
                                    const itemAnchor = interactor.field("_itemAnchor").value;
                                    if (!itemAnchor)
                            ...
                            console.error("whitelist rpg error:", e);
                        }
                    };
                })(),
                toolTip: "You need to hole grip and trigger."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist Spear",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("RPGRocketSpear", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
                        ...
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("RPGRocketEgg", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
            ...
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist Rocket Dog RPG?",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("RobotDogRPG", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
                        ...
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("ChristmasBox", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
            ...
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist Sell Machine",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("ItemSellingMachineController", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
                        ...
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("InflatedBalloon", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
            ...
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist HeartBalloon",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            for (let handIndex = 0; handIndex <= 1; handIndex++) {
                                try {
                                    ...
                                    if (!grabbable || grabbable.isNull())
                                        continue;
                                    spawnNetworkPrefab("InflatedHeartBalloon", getTransform(grabbable).method("get_position").invoke(), getTransform(grabbable).method("get_rotation").invoke());
                                }
                                catch (_) { }
                            }
                        }
                    ...
                    return () => {
                        try {
                            if (!selectedPlayer || selectedPlayer.isNull())
                                return;
                            const pos = getTransform(selectedPlayer).method("get_position").invoke();
                            const down = Vector3.field("downVector").value;
                            const forward = getTransform(selectedPlayer).method("get_forward").invoke();
                            const spawnPos = Vector3.method("op_Addition").invoke(pos, Vector3.method("op_Multiply").invoke(down, 0.5));
                            const spawned = PrefabGen.method("SpawnItem", 4).invoke(Il2Cpp.string("item_snowball"), spawnPos, identityQuaternion, NULL);
                            if (!spawned || spawned.isNull())
                                return;
                            const gbo = spawned.method("GetComponent", 1).inflate(GBOClass).invoke();
                            if (!gbo || gbo.isNull())
                                return;
                            gbo.method("set_colorHue").invoke(20);
                            gbo.method("set_colorSaturation").invoke(100);
                            gbo.method("AddExternalForceVelocity", 1).invoke(Vector3.method("op_Multiply").invoke(forward, 5.0));
                        }
                        catch (e) {
                            console.error("whitelist pee error:", e);
                        }
                    };
                })(),
                toolTip: "Makes them piss."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist Nut",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                ...
                toolTip: "Makes them nut."
            }));
            buttons[12].push(new ButtonInfo({
                buttonText: "Whitelist Shit",
                isTogglable: true,
                method: (() => {
                    return () => {
                        try {
                            ...
                            if (!gbo || gbo.isNull())
                                return;
                            gbo.method("set_colorHue").invoke(-20);
                            gbo.method("set_colorSaturation").invoke(50);
                            gbo.method("AddExternalForceVelocity", 1).invoke(Vector3.method("op_Multiply").invoke(down, 5.0));
                        }
                        catch (e) {
                            console.error("whitelist pee error:", e);
                        }
            ...
            buttons[12].push(new ButtonInfo({
                ...
                method: () => {
                    try {
                        if (!selectedPlayer || selectedPlayer.isNull())
                            return;
                        const targetPos = getTransform(selectedPlayer).method("get_position").invoke();
                        PrefabGen.method("SpawnItem", 4).invoke(Il2Cpp.string(itemIDs[currentItemIndex]), targetPos, identityQuaternion, NULL);
                        sendNotification("Gave " + itemIDs[currentItemIndex] + " to player", false);
                    }
                    catch (e) {
                        console.error("give item error:", e);
                    }
                },
                toolTip: "Spawn current item at selected player's position."
            }));
        }
        buttons[12].forEach(b => buttonMap.set(b.buttonText, b));
    }
    ...
    LateUpdate.implementation = function () {
        ...
        //if (myNP == null) {
        //    const players = Object.method("FindObjectsOfType").inflate(NetPlayer).invoke();
        //    if (players) {// this menu was by harmony and lottabtle
        //        for (let i = 0; i < players.length; i++) {
        //            const netPlayer = players.get(i);
        //            if (!netPlayer.method("get_IsMine").invoke()) continue;// this menu was by harmony and lottabtle
        //            myNP = netPlayer; // cache it
        //            break; // stop once we found it
        //        }
        //    }
    ...
    stashQOLFix = true;
    console.log(`
	if u see this it means it worked!!
	enable dev menu inside overpowered mods.
	this menu was by harmony and lottabtle no skidding!!!
